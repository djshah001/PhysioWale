  ...
  const getMetricStatus = () => {
    if (!userData.height || !userData.weight) {
      return (
        ...
        >
          <Text className="text-secondary-200 font-pmedium">Add your height and weight</Text>
          <FontAwesome5 name="arrow-right" size={14} color="#055300" className="ml-2" />
        </TouchableOpacity>
      );
    }
    
    if (loading) {
      return <Text className="text-gray-500 text-center mt-2">Calculating...</Text>;
    }
